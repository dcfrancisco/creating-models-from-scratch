...
Expand attention into multiple heads and combine them.

## Learning outcomes

Explain and implement multi-head attention in an evidence-backed way.
...
Implement and document multi-head attention with tests, experiments, and guide updates appropriate to the work package stage.
