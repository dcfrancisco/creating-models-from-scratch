# WP-009: FFN, normalization, and residual
...
FFN, normalization, and residual
...
Complete the Transformer block internals.

## Learning outcomes

Explain and implement ffn, normalization, and residual in an evidence-backed way.
...
Implement and document ffn, normalization, and residual with tests, experiments, and guide updates appropriate to the work package stage.
