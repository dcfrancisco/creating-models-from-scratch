...
Build a deterministic character-level tokenizer with persistence and tests.

## Learning outcomes

Explain and implement character tokenizer in an evidence-backed way.
...
Implement and document character tokenizer with tests, experiments, and guide updates appropriate to the work package stage.
