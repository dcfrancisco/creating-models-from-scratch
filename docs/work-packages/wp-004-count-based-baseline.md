...
Implement the smallest next-token baseline to establish the full path to generation.

## Learning outcomes

Explain and implement count-based baseline in an evidence-backed way.
...
Implement and document count-based baseline with tests, experiments, and guide updates appropriate to the work package stage.
