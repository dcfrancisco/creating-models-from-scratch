...
Select a legal small corpus, record provenance, and inspect its properties.

## Learning outcomes

Explain and implement dataset acquisition and inspection in an evidence-backed way.
...
Implement and document dataset acquisition and inspection with tests, experiments, and guide updates appropriate to the work package stage.
