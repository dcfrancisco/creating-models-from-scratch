...
Compare baseline, bigram, and Transformer behavior with evidence.

## Learning outcomes

Explain and implement evaluation and comparative experiments in an evidence-backed way.
...
Implement and document evaluation and comparative experiments with tests, experiments, and guide updates appropriate to the work package stage.
