...
Measure performance and optimize carefully for constrained CPUs.

## Learning outcomes

Explain and implement profiling and cpu optimization in an evidence-backed way.
...
Implement and document profiling and cpu optimization with tests, experiments, and guide updates appropriate to the work package stage.
