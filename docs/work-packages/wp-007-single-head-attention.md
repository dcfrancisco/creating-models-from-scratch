...
Implement explicit causal attention with shape and masking evidence.

## Learning outcomes

Explain and implement single-head causal self-attention in an evidence-backed way.
...
Implement and document single-head causal self-attention with tests, experiments, and guide updates appropriate to the work package stage.
