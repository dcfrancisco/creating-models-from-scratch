...
Establish the exact capabilities and limits of the target CPU-first environment.

## Learning outcomes

Explain and implement hardware qualification in an evidence-backed way.
...
Implement and document hardware qualification with tests, experiments, and guide updates appropriate to the work package stage.
