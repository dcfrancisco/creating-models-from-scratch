...
Explain and implement embeddings and position in an evidence-backed way.
...
Implement and document embeddings and position with tests, experiments, and guide updates appropriate to the work package stage.
