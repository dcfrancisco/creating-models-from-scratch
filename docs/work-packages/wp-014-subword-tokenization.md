...
Explore subword tokenization only after the character baseline is understood.

## Learning outcomes

Explain and implement optional subword tokenization in an evidence-backed way.
...
Implement and document optional subword tokenization with tests, experiments, and guide updates appropriate to the work package stage.
