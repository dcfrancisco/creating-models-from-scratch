...
Checkpoint and recovery lifecycle
...
Make checkpoint save/resume compatibility explicit and testable.

## Learning outcomes

Explain and implement checkpoint and recovery lifecycle in an evidence-backed way.
...
Implement and document checkpoint and recovery lifecycle with tests, experiments, and guide updates appropriate to the work package stage.
